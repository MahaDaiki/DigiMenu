    ...
    <section class="section section-lg bg-default">
        ...
        <div class="container mt-5">
            ...
            <form method="post" action="{{ route('subscriptions.update') }}">
                ...
                <input class="form-control mt-3" type="text" name="price" value="{{ $subscription->price }}" placeholder="Price*">
                <input class="form-control mt-3" type="number" name="article_number" value="{{ $subscription->article_number }}" placeholder="Article Number*">
                <input class="form-control mt-3" type="number" name="scan_limit"  value="{{ $subscription->scan_limit }}" placeholder="Scan Limit*">
                <div class="mt-3">
                ...
                <div class="d-flex justify-content-center">
                    <input class="btn btn-primary mt-3" type="submit" value="Edit Plan">
                </div>
            </form>
